...
поддерживают поля: Регион, Район, Заметки, Место сбора, а также примечания к
...
-------------------------
Сервис массовых изменений
-------------------------

Мотивация
---------

При внесении данных в 


Принцип работы
--------------

Использование сервиса массовых изменений требует, чтобы пользователь имел права
куратора гербарного акронима или подраздела гербария.




Интеграция в форму редактирования
---------------------------------

Показать иллюстрации, как сервис интегрирован в систему редактирования.
