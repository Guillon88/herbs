...
Если пользователь с правами куратора привязан к гербарной группе, то он является куратором только данной гербарной группы (см. также _`Группы пользователей и права`). 
...
Крайне рекомендуемое к заполнению поле. Для заполнения можно использовать флажок на прилагаемой карте google. При изменении его позиции, автоматически изменяются и координаты. 
...
.. _`персональной странице образца`:
